...
Route::prefix('auth/customer')->group(function () {
    ...
    Route::Post('register', [CostomerController::class, 'store']);
...
Route::middleware(custommiddleware::class)->group(function () {
    ...
    Route::post('adminusers/update/{id}', [AdminuserController::class, 'update']);
    ...
    Route::prefix('costomer')->group(function () {
        ...
        Route::post('whatsappverify/{id}', [CostomerController::class, 'whatsappverify']);
    ...
    Route::prefix('order')->group(function () {
        ...
        Route::post('discount/{id}', [OrderController::class, 'addDiscount']);
